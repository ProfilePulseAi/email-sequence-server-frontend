    ...
    <div className="space-y-6">
      ...
      <div className="md:flex md:items-center md:justify-between">
        ...
        <div className="mt-4 md:mt-0 md:ml-4">
          <button
            onClick={() => toast.success('Add mailbox feature coming soon!')}
              ...
              <div key={mailbox.id} className="p-6 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className={`h-3 w-3 rounded-full ${mailbox.isActive ? 'bg-green-400' : 'bg-gray-400'}`}></div>
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 grid grid-cols-2 gap-4 text-sm text-gray-500">
                        <div>
                          <p><span className="font-medium">SMTP:</span> {mailbox.smtpHost}:{mailbox.smtpPort}</p>
                        </div>
                        <div>
                          <p><span className="font-medium">IMAP:</span> {mailbox.imapHost}:{mailbox.imapPort}</p>
                        </div>
                      </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex space-x-1">
                      <button
                        ...
                        title={mailbox.isActive ? 'Deactivate account' : 'Activate account'}
                      >
                        {mailbox.isActive ? (
                      ...
                      <button
                        onClick={() => toast.success('Edit mailbox feature coming soon!')}
                        className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full"
                        title="Edit account"
                      >
